...
class ShouldReturnHome final : public BT::ConditionNode {
 public:
  ShouldReturnHome(const std::string& name, const BT::NodeConfig& config);
  static BT::PortsList providedPorts() { return {}; }
  BT::NodeStatus tick() override;
};

class ReturnHome final : public BT::StatefulActionNode {
 public:
  ReturnHome(const std::string& name, const BT::NodeConfig& config);
  static BT::PortsList providedPorts() { return {}; }
...
class AttackTarget final : public BT::StatefulActionNode {
 public:
