...
inline Vector3 Vector3::reflectAboutljs(const Vector3& normal) const {
...
inline Vector3 Vector3::reflectionDirectionljs(const Vector3& normal)const {
	return -reflectAboutljs(normal).direction();
}
//----------------------------------------------------------------------------
