...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::sudoku::SudokuRequest)},
  { 7, -1, -1, sizeof(::sudoku::SudokuResponse)},
};
...
const ::_pbi::DescriptorTable descriptor_table_sudoku_2eproto = {
    false, false, 209, descriptor_table_protodef_sudoku_2eproto,
    "sudoku.proto",
...
uint8_t* SudokuRequest::_InternalSerialize(
  ...
  // string checkerboard = 1;
  if (!this->_internal_checkerboard().empty()) {
...
void SudokuResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_solved() != 0) {
    _this->_internal_set_solved(from._internal_solved());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
