                                       ...
                                       unsigned char *output)
{
   ...
   return 0 !=
          PKCS5_PBKDF2_HMAC(
             password, (int)password_len, salt, (int)salt_len, (int)iterations, EVP_sha1(), (int)output_len, output);
}
                                         ...
                                         unsigned char *output)
{
   ...
   return 0 !=
          PKCS5_PBKDF2_HMAC(
             password, (int)password_len, salt, (int)salt_len, (int)iterations, EVP_sha256(), (int)output_len, output);
}
