...
test_decimal128_from_string__simple(void)
{
   ...
   // OK
   ASSERT(bson_decimal128_from_string_w_len("0.000001038459371706965525706099265844019", 41, &untruncated_significand));
   ASSERT(bson_decimal128_from_string_w_len("-0.000001038459371706965525706099265844019", 42, &truncated_significand));
