...
namespace thread
{
typedef std::recursive_mutex ThreadMutex;
...
#define DEBUG_MSG(MSG) ::KBEngine::debugPrint(MSG)
#define INFO_MSG(MSG) ::KBEngine::debugPrint(MSG)
#define WARNING_MSG(MSG) ::KBEngine::debugPrint(MSG)
#define ERROR_MSG(MSG) ::KBEngine::errorPrint(MSG)
#define KBE_ASSERT(EXPR) assert(EXPR)
#define WATCH_OBJECT(NAME, OBJECT) ((void)0)
