...
class delete_many {
   public:
    ...
    ///
    explicit operator v1::bulk_write::delete_many() const {
        using bsoncxx::v_noabi::to_v1;
        using v_noabi::to_v1;

        v1::bulk_write::delete_many ret{bsoncxx::v1::document::value{to_v1(_filter.view())}};
    ...
    ///
    explicit delete_many(bsoncxx::v_noabi::document::view_or_value filter) : _filter{std::move(filter)} {}
...
///
inline v_noabi::model::delete_many from_v1(v1::bulk_write::delete_many v) {
    return {std::move(v)};
}
...
///
inline v1::bulk_write::delete_many to_v1(v_noabi::model::delete_many const& v) {
    return v1::bulk_write::delete_many{v};
}
