...
class client_encryption {
   ...
   public:
    ...
    ///
    /* explicit(false) */ client_encryption(v1::client_encryption ce) : _ce{std::move(ce)} {}
    ...
    ///
    explicit operator v1::client_encryption() && {
        return std::move(_ce);
    }
    ...
    ///
    explicit operator v1::client_encryption() const& = delete;
