...
class delete_one_result {
   ...
   public:
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL() ~delete_one_result();
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL() delete_one_result(delete_one_result&& other) noexcept;
    ...
    /// - `other` is in an assign-or-destroy-only state.
    ///
    MONGOCXX_ABI_EXPORT_CDECL(delete_one_result&) operator=(delete_one_result&& other) noexcept;

    ///
    /// Copy construction.
    ///
    MONGOCXX_ABI_EXPORT_CDECL() delete_one_result(delete_one_result const& other);

    ///
    /// Copy assignment.
    ///
    MONGOCXX_ABI_EXPORT_CDECL(delete_one_result&) operator=(delete_one_result const& other);
    ...
    friend bool operator!=(delete_one_result const& lhs, delete_one_result const& rhs) {
        return !(lhs == rhs);
    }
    /// @}
    ///
