...
class find_one_and_update_options {
   ...
   public:
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL() ~find_one_and_update_options();
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL() find_one_and_update_options(find_one_and_update_options&& other) noexcept;
    ...
    /// - `other` is in an assign-or-destroy-only state.
    ///
    MONGOCXX_ABI_EXPORT_CDECL(find_one_and_update_options&) operator=(find_one_and_update_options&& other) noexcept;

    ///
    /// Copy construction.
    ///
    MONGOCXX_ABI_EXPORT_CDECL() find_one_and_update_options(find_one_and_update_options const& other);

    ///
    /// Copy assignment.
    ///
    MONGOCXX_ABI_EXPORT_CDECL(find_one_and_update_options&) operator=(find_one_and_update_options const& other);
...
///
/// @file
/// Provides @ref mongocxx::v1::find_one_and_update_options.
///
