...
v_noabi::cursor search_index_view::list(v_noabi::options::aggregate const& options) try {
    scoped_bson opts_doc;

    v_noabi::options::aggregate::internal::append_to(options, opts_doc);

    return v1::search_indexes::internal::list_impl(
...
v_noabi::cursor search_index_view::list(
    ...
    v_noabi::options::aggregate const& options) try {
    scoped_bson opts_doc;
...
std::string search_index_view::create_one(bsoncxx::v_noabi::document::view_or_value definition) try {
    scoped_bson doc;
...
std::string search_index_view::create_one(
    v_noabi::client_session const& session,
    bsoncxx::v_noabi::document::view_or_value definition) try {
    scoped_bson doc;
    append_to(definition.view(), nullptr, nullptr, doc);
...
std::string search_index_view::create_one(v_noabi::search_index_model const& model) try {
    scoped_bson doc;
...
std::string search_index_view::create_one(
    v_noabi::client_session const& session,
    v_noabi::search_index_model const& model) try {
    scoped_bson opts_doc;
...
void search_index_view::drop_one(
    v_noabi::client_session const& session,
    bsoncxx::v_noabi::string::view_or_value name) try {
    scoped_bson opts_doc;
...
void search_index_view::update_one(
    bsoncxx::v_noabi::string::view_or_value name,
    bsoncxx::v_noabi::document::view_or_value definition) try {
    return v1::search_indexes::internal::update_one_impl(
        v1::search_indexes::internal::get_collection(check_moved_from(_indexes)),
        name.terminated().data(),
