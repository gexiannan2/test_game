...
replace::replace(v1::replace_one_options opts)
    : _bypass_document_validation{opts.bypass_document_validation()},
      _collation{[&]() -> decltype(_collation) {
          if (auto& opt = v1::replace_one_options::internal::collation(opts)) {
      ...
      _let{[&]() -> decltype(_let) {
          if (auto& opt = v1::replace_one_options::internal::let(opts)) {
              return bsoncxx::v_noabi::from_v1(std::move(*opt));
          }
          return {};
      }()},
      _sort{[&]() -> decltype(_sort) {
          if (auto& opt = v1::replace_one_options::internal::sort(opts)) {
              return bsoncxx::v_noabi::from_v1(std::move(*opt));
          }
          return {};
      }()},
      _comment{std::move(v1::replace_one_options::internal::comment(opts))} {}
