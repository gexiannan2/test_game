...
#else
#define SILENCE_IGNORED_ATTRIBUTES_BEGIN() BSONCXX_PRIVATE_FORCE_SEMICOLON
#define SILENCE_IGNORED_ATTRIBUTES_END() BSONCXX_PRIVATE_FORCE_SEMICOLON
#endif
...
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_append_deletemany);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_append_deleteone);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_append_insertone);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_append_replaceone);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_append_updatemany);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_append_updateone);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_check_acknowledged);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_deletemanyopts_destroy);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_deletemanyopts_new);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_deletemanyopts_set_collation);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_deletemanyopts_set_hint);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_deleteoneopts_destroy);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_deleteoneopts_new);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_deleteoneopts_set_collation);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_deleteoneopts_set_hint);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_destroy);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_execute);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_insertoneopts_destroy);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_insertoneopts_new);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_new);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_replaceoneopts_destroy);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_replaceoneopts_new);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_replaceoneopts_set_collation);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_replaceoneopts_set_hint);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_replaceoneopts_set_sort);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_replaceoneopts_set_upsert);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_serverid);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_set_client);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_set_session);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_updatemanyopts_destroy);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_updatemanyopts_new);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_updatemanyopts_set_arrayfilters);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_updatemanyopts_set_collation);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_updatemanyopts_set_hint);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_updatemanyopts_set_upsert);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_updateoneopts_destroy);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_updateoneopts_new);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_updateoneopts_set_arrayfilters);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_updateoneopts_set_collation);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_updateoneopts_set_hint);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_updateoneopts_set_sort);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwrite_updateoneopts_set_upsert);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteexception_destroy);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteexception_error);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteexception_errorreply);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteexception_writeconcernerrors);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteexception_writeerrors);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteopts_destroy);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteopts_new);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteopts_set_bypassdocumentvalidation);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteopts_set_comment);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteopts_set_extra);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteopts_set_let);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteopts_set_ordered);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteopts_set_serverid);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteopts_set_verboseresults);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteopts_set_writeconcern);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteresult_deletedcount);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteresult_deleteresults);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteresult_destroy);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteresult_insertedcount);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteresult_insertresults);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteresult_matchedcount);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteresult_modifiedcount);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteresult_serverid);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteresult_updateresults);
MONGOCXX_PRIVATE_MOCKED_EXPORT(bulkwriteresult_upsertedcount);
...
MONGOCXX_PRIVATE_MOCKED_EXPORT(client_bulkwrite_new);
...
MONGOCXX_PRIVATE_MOCKED_EXPORT(client_pool_set_oidc_callback);
...
MONGOCXX_PRIVATE_MOCKED_EXPORT(client_set_oidc_callback);
...
MONGOCXX_PRIVATE_MOCKED_EXPORT(oidc_callback_destroy);
MONGOCXX_PRIVATE_MOCKED_EXPORT(oidc_callback_new_with_user_data);
MONGOCXX_PRIVATE_MOCKED_EXPORT(oidc_callback_params_get_timeout);
MONGOCXX_PRIVATE_MOCKED_EXPORT(oidc_callback_params_get_user_data);
MONGOCXX_PRIVATE_MOCKED_EXPORT(oidc_callback_params_get_username);
MONGOCXX_PRIVATE_MOCKED_EXPORT(oidc_callback_params_get_version);
MONGOCXX_PRIVATE_MOCKED_EXPORT(oidc_credential_new);
MONGOCXX_PRIVATE_MOCKED_EXPORT(oidc_credential_new_with_expires_in);
