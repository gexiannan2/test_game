...
mongoc_apm_topology_opening_t const* to_mongoc(void const* ptr) {
    return static_cast<mongoc_apm_topology_opening_t const*>(ptr);
}
...
topology_opening topology_opening::internal::make(mongoc_apm_topology_opening_t const* ptr) {
    return {ptr};
}

mongoc_apm_topology_opening_t const* topology_opening::internal::as_mongoc(topology_opening const& self) {
