...
delete_many_options::delete_many_options(delete_many_options&& other) noexcept
    : _impl{exchange(other._impl, nullptr)} {}

delete_many_options& delete_many_options::operator=(delete_many_options&& other) noexcept {
    if (this != &other) {
...
delete_many_options::delete_many_options(delete_many_options const& other) : _impl{new impl{impl::with(other)}} {}

delete_many_options& delete_many_options::operator=(delete_many_options const& other) {
    if (this != &other) {
...
bsoncxx::v1::stdx::optional<bsoncxx::v1::document::view> delete_many_options::collation() const {
...
bsoncxx::v1::stdx::optional<v1::write_concern> delete_many_options::write_concern() const {
...
bsoncxx::v1::stdx::optional<v1::hint> delete_many_options::hint() const {
...
bsoncxx::v1::stdx::optional<bsoncxx::v1::document::view> const delete_many_options::let() const {
...
bsoncxx::v1::stdx::optional<v1::hint>& delete_many_options::internal::hint(delete_many_options& self) {
    return impl::with(self)._hint;
}

bsoncxx::v1::stdx::optional<bsoncxx::v1::document::value>& delete_many_options::internal::let(
    delete_many_options& self) {
    return impl::with(self)._let;
}

bsoncxx::v1::stdx::optional<bsoncxx::v1::types::value>& delete_many_options::internal::comment(
    delete_many_options& self) {
    return impl::with(self)._comment;
}
