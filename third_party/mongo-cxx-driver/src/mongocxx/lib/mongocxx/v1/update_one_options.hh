...
class update_one_options::internal {
   public:
    ...
    static bsoncxx::v1::stdx::optional<v1::read_concern> const& read_concern(update_one_options const& self);
    ...
    static bsoncxx::v1::stdx::optional<bsoncxx::v1::document::value>& sort(update_one_options& self);
    static bsoncxx::v1::stdx::optional<bsoncxx::v1::types::value>& comment(update_one_options& self);
    static bsoncxx::v1::stdx::optional<v1::read_concern>& read_concern(update_one_options& self);
