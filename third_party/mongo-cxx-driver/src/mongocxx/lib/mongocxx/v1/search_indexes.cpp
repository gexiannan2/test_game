...
v1::cursor search_indexes::list(v1::aggregate_options const& opts) {
    ...
    return internal::list_impl(impl::with(this)->_coll, nullptr, opts_doc.bson(), get_read_prefs(opts));
}
...
v1::cursor search_indexes::list(bsoncxx::v1::stdx::string_view name, v1::aggregate_options const& opts) {
    ...
    return internal::list_impl(
        impl::with(this)->_coll, std::string{name}.c_str(), opts_doc.bson(), get_read_prefs(opts));
}
...
std::string search_indexes::create_one(bsoncxx::v1::document::view definition) {
    ...
    return internal::create_one_impl(v1::search_indexes::internal::get_collection(*this), doc.bson(), nullptr);
}
...
std::string search_indexes::create_one(v1::client_session const& session, bsoncxx::v1::document::view definition) {
    ...
    return internal::create_one_impl(v1::search_indexes::internal::get_collection(*this), doc.bson(), opts_doc.bson());
}
...
std::string search_indexes::create_one(
    ...
    return internal::create_one_impl(v1::search_indexes::internal::get_collection(*this), doc.bson(), opt_doc.bson());
}
...
void search_indexes::drop_one(bsoncxx::v1::stdx::string_view name) {
    return internal::drop_one_impl(impl::with(this)->_coll, std::string{name}.c_str(), nullptr);
}
...
void search_indexes::drop_one(v1::client_session const& session, bsoncxx::v1::stdx::string_view name) {
    ...
    return internal::drop_one_impl(impl::with(this)->_coll, std::string{name}.c_str(), opts_doc.bson());
}

void search_indexes::update_one(bsoncxx::v1::stdx::string_view name, bsoncxx::v1::document::view definition) {
    return internal::update_one_impl(impl::with(this)->_coll, std::string{name}.c_str(), definition, nullptr);
}
...
void search_indexes::update_one(
    ...
    return internal::update_one_impl(impl::with(this)->_coll, std::string{name}.c_str(), definition, opts_doc.bson());
}
...
v1::cursor search_indexes::internal::list_impl(
...
std::string
search_indexes::internal::create_one_impl(mongoc_collection_t* coll, bson_t const* index, bson_t const* opts) {
    auto const reply = create_impl(
        coll,
        scoped_bson{BCON_NEW(
                        "createSearchIndexes",
...
void search_indexes::internal::drop_one_impl(mongoc_collection_t* coll, char const* name, bson_t const* opts) {
...
void search_indexes::internal::update_one_impl(
    mongoc_collection_t* coll,
    char const* name,
    bsoncxx::v1::document::view definition,
    bson_t const* opts) {
